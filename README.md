...
### Multi-service and microservice projects



If your repository contains several service groups, you can point depvex at a parent folder such as services, air, ground, or server.



You can also define a simple config file named .depvex or depvex.json in the project root:
...
depvex scan --multi services .

depvex check --multi services .

depvex watch --multi services .

```



Each target folder is scanned independently, and each one gets its own requirements.txt file.
